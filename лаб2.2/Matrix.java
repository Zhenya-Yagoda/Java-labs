...
public class Matrix {
    ...
    private int m;
    String [][] copymas;
    public Matrix(){ //конструктор порожньої матриці
        String [][] emptymas=emptym();
    }
    public Matrix(String arg1, String arg2){ //конструктор заданої матриці
        this.n=getnum(arg1);
        this.m=getnum(arg2);
    }
    public Matrix(String [][]mas){ //конструктор копії матриці
        this.copymas=new String[mas.length][mas[0].length];
    }
    ...
    public static String[][] emptym(){ //порожня матриця
        String [][] mas;
    ...
    public String[][] copymas(String [][] mas){   ///copy mas
    ...
    public String[][] putvalue() { //заповнення значень в масив
        String [][] mas;
    ...
    public static String[][] printmas(String [][]mas) { //print array
        System.out.println("-------------------");
    ...
    public String[][] ramdommat(){
        String[][] mas= new String[this.n][this.m];
        for (int i = 0; i < this.n; i++) {
            for (int j = 0; j < this.m; j++) {
                mas[i][j] = ranvalue();
            }
